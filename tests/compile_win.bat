...
set INC=-Itests/mocks -Itests -Icomponents/interpreter/include -Icomponents/espnow_comm/include -Icomponents/hw_drivers/include -Icomponents/lcd_touch/include -Icomponents/ui_lvgl/include
